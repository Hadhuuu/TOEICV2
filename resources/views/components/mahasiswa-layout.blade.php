        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
            <aside
                ...
                <nav class="space-y-1.5">
                    ...
                    <a href="{{ route('mahasiswa.pendaftaran.create') }}" class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-md text-sm font-medium transition-colors duration-150 {{ request()->routeIs('mahasiswa.pendaftaran.create') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('mahasiswa.pengumuman.index') }}" class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-md text-sm font-medium transition-colors duration-150 {{ request()->routeIs('mahasiswa.pengumuman.index') ? 'active' : '' }}">
