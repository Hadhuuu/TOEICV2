        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
            <aside
                ...
                <nav class="space-y-1.5">
                    ...
                    <a href="{{ route('admin.pengumuman.create') }}" class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-md text-sm font-medium transition-colors duration-150 {{ request()->routeIs('admin.pengumuman.*') ? 'active' : '' }}">
...
<<<<<<< HEAD
=======
                    <a href="{{ route('admin.hasil_ujian.import.form') }}" class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm {{ request()->routeIs('admin.hasil_ujian.import.form') ? 'active' : '' }}">
                        ...
                        <span>Impor Hasil Ujian</span>
>>>>>>> 293700520da38632feccfbcfe251ac866f133125
                    </a>
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 dark:bg-slate-900"> {{-- Sedikit lebih terang dari bg-slate-900 --}}
                 ...
                 <footer class="text-center p-4 text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800">
                    © {{ date('Y') }} TOEIC_V2. UPA Bahasa. All rights reserved.
                </footer>
            </div>
        </div>
        @stack('scripts')
